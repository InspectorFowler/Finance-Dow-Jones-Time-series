VECM.model<-function(cluster.data,pred.data,real.data,lagvalue,rvalue=1,aheadv,dir=TRUE){
    ...
    write.table(real.data,"C:/Users/akhilesh/Desktop/Course Materials/ISEN 613/Final Project/2.Excel Data/VECM.Predict.csv",
                sep=",",row.names=FALSE)
    write.table(real.data,"C:/Users/akhilesh/Desktop/Course Materials/ISEN 613/Final Project/2.Excel Data/VECM.Direction.csv",
                sep=",",row.names=FALSE)
    for (i in 2:ncol(cluster.data)){
        ...
        write.table(pred,"C:/Users/akhilesh/Desktop/Course Materials/ISEN 613/Final Project/2.Excel Data/VECM.Predict.csv",sep=",",
                    row.names=FALSE,append=TRUE)
        if (dir==TRUE) write.table(direction,
                                   "C:/Users/akhilesh/Desktop/Course Materials/ISEN 613/Final Project/2.Excel Data/VECM.Direction.csv",sep=",",
                                   row.names=FALSE,append=TRUE)
    }
    options(warn=0)
}