clusterindex<-function(cluster.index,stock.data,divisor,Prcnt=TRUE,Std=FALSE,charts=FALSE,charts2=FALSE){
    ...
    temp.minidex$Date<-as.Date(as.character(temp.minidex$Date),format="%Y-%m-%d")
